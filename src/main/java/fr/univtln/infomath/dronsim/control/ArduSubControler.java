...
public class ArduSubControler implements Controler {
    ...
    private void sendPosition() throws IOException {
        ...
        GpsInput gpsInput = GpsInput.builder()
            ...
            .gpsId(0)
            .ignoreFlags(EnumValue.create(GpsInputIgnoreFlags.GPS_INPUT_IGNORE_FLAG_VEL_HORIZ, GpsInputIgnoreFlags.GPS_INPUT_IGNORE_FLAG_VEL_VERT, GpsInputIgnoreFlags.GPS_INPUT_IGNORE_FLAG_SPEED_ACCURACY)) // Flags indiquant quels champs à ignorer
