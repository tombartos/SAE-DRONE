...
\newcommand{\makeincludegraphics}[2][]{%
...
\begin{figure}[p]
    \makeincludegraphics[width=1.1\textwidth]{ardupilot_server_components.png}
    \caption{Diagramme de composantes (rendu côté serveur)}
    \label{fig:fwclient}
\end{figure}

\begin{figure}[p]
    \makeincludegraphics[width=1.1\textwidth]{ardupilot_client_components.png}
    \caption{Diagramme de composantes (rendu côté client)}
    \label{fig:fwserveur}
\end{figure}

\begin{figure}[p]
    \makeincludegraphics[width=\textwidth]{simulateur_uc.png}
    \caption{Diagramme de cas d'usage}
    \label{fig:uc}
\end{figure}

\begin{figure}[p]
    \makeincludegraphics[width=\textwidth]{conn_pilote_seq.png}
...
\begin{figure}[p]
    \centering
    \makeincludegraphics[width=1\textwidth]{classes.png}
