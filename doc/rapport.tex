...
%
\begin{figure}
    \makeincudegraphics[width=\textwidth]{conn_pilote_local_renderer_seq.png}
    \caption{Connexion d'un pilote avec rendu en local.}
\end{figure}
\begin{figure}
    \makeincudegraphics[width=\textwidth]{conn_pilote_remote_renderer_seq.png}
